...
export default function MobileStickyCTA() {
  return (
    <a
      ...
      className="fixed bottom-28 right-5 sm:bottom-32 sm:right-7 z-50 flex items-center justify-center w-14 h-14 rounded-full bg-gradient-to-r from-blue-600 to-cyan-500 text-white shadow-2xl shadow-cyan-500/35 border border-cyan-400/30 transition-all hover:scale-110 active:scale-95 group"
    >
