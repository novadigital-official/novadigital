...
import { MessageSquare, Phone, Mail, MapPin, CheckCircle2, AlertCircle, ShieldCheck } from "lucide-react";
...
const formSchema = z.object({
  ...
  phone: z
    ...
    .max(15, "Geçersiz telefon formatı"),
  service: z.string(),
  ...
  return (
    <section id="iletisim" className="py-16 md:py-24 relative bg-[#0f172a] overflow-hidden">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        {/* Header - Unified Center Alignment */}
        ...
        <div className="grid lg:grid-cols-12 gap-8 items-stretch">
          {/* Left - Balanced Height Column */}
          <div className="lg:col-span-5 flex flex-col justify-between space-y-3.5">
            <a
              href="https://wa.me/905070871789?text=Merhaba%2C%20%C3%BCcretsiz%20dijital%20analiz%20almak%20istiyorum."
              target="_blank"
              rel="noopener noreferrer"
              className="p-4 sm:p-5 rounded-2xl flex items-center gap-4 border border-emerald-500/30 bg-emerald-950/20 hover:border-emerald-500/50 hover:bg-emerald-950/30 transition-all duration-300 shadow-lg shadow-emerald-950/30"
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <h3 className="text-sm font-extrabold text-white truncate">WhatsApp ile Yazın</h3>
            ...
            <a
              ...
              className="p-4 sm:p-5 rounded-2xl flex items-center gap-4 border border-cyan-500/30 bg-cyan-950/20 hover:border-cyan-500/50 hover:bg-cyan-950/30 transition-all duration-300 shadow-lg shadow-cyan-950/30"
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <h3 className="text-sm font-extrabold text-white truncate">0507 087 17 89</h3>
                <p className="text-xs text-slate-400">09:00 – 20:00 Doğrudan Arama</p>
              </div>
            </a>

            <div className="p-4 sm:p-5 rounded-2xl bg-slate-900/90 border border-slate-800 text-xs text-slate-300 space-y-3">
              <div className="flex items-center gap-3">
                <Mail className="w-4 h-4 text-cyan-400 shrink-0" />
                <span className="truncate">info@novadigital.com.tr</span>
              </div>
            ...
            {/* Trust & Guarantee Box to Match Form Height */}
            <div className="p-4 rounded-2xl bg-slate-900/60 border border-slate-800/80 flex items-center gap-3.5">
              ...
              <div className="text-xs text-slate-300 leading-snug">
                <span className="font-bold text-white block">Tasarım Onay Garantisi</span>
                Sitenizi canlı test ortamında görüp onay vermeden bakiye ödemezsiniz.
              </div>
            </div>
          </div>

          {/* Right — Form */}
          <div className="lg:col-span-7 p-6 sm:p-8 rounded-2xl bg-slate-900/90 border border-slate-800 shadow-2xl flex flex-col justify-between">
            <div>
              ...
              {submitted ? (
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                  ...
                  <button
                    type="submit"
                    className="btn-shimmer w-full py-3.5 rounded-xl text-xs font-bold text-white shadow-xl shadow-cyan-500/20"
                  >
                    Ücretsiz Teklif Al
                  </button>
