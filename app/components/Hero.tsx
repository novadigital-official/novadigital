...
export default function Hero() {
  return (
    <section className="relative pt-28 sm:pt-32 pb-14 overflow-hidden">
      {/* Grid Alignment Mesh */}
        ...
        <div className="grid lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col items-start text-left">
            ...
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-blue-500/10 border border-blue-500/20 text-blue-300 text-xs font-medium tracking-wide mb-5 backdrop-blur-md">
              ...
              <span>Antalya & Türkiye Geneli Yazılım Stüdyosu</span>
            </div>

            {/* High-Impact Display Headline with Typographic Balancer */}
            <h1 className="text-3xl sm:text-5xl lg:text-[3.4rem] font-extrabold tracking-tight text-white leading-[1.12] mb-5">
              <Balancer>
                Web Siteniz Sadece Görünmesin,{" "}
                <span className="text-shimmer">
                  İşletmenize Müşteri Getirsin.
                </span>
              </Balancer>
            </h1>
            ...
            <p className="text-sm sm:text-base text-slate-300 font-normal leading-relaxed max-w-xl mb-7">
              <Balancer>
                <strong className="text-white font-semibold">2 Günde</strong> yayına
                alınan, Google Ads ve Meta reklamlarına tam entegre, yüksek dönüşümlü
                dijital web sistemleri ile markanızı büyütün.
              </Balancer>
            </p>
            ...
            {/* 4 Trust Metrics (Harmonious Single Palette) */}
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 pt-5 border-t border-white/10 w-full text-xs text-slate-400 font-medium">
              ...
              <div className="flex items-center gap-2">
                ...
                <span>%100 SEO Uyum</span>
              </div>
              <div className="flex items-center gap-2">
                <Tag className="w-4 h-4 text-blue-400 shrink-0" />
                <span>Şeffaf Fiyatlar</span>
              </div>
            </div>
          </div>
